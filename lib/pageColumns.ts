...
export const PAGE_META_COLUMNS =
  'id, parent_id, title, icon, tags, favorite, favorite_position, type, position, created_at, updated_at, deleted_at, summary, cover_url, is_shared, share_token, comments_enabled, full_width'
