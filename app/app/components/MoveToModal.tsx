  ...
  return (
    <div className="fixed inset-0 z-[400] flex items-center justify-center px-4"
      ...
      <div className="w-full flex flex-col rounded-2xl overflow-hidden"
        style={{ maxWidth: 400, maxHeight: '66vh', background: 'var(--card-bg)', boxShadow: '0 24px 64px rgba(0,0,0,0.22)', border: '1px solid var(--border)' }}>
        <div className="px-4 pt-4 pb-3 flex items-center gap-2" style={{ borderBottom: '1px solid var(--border)' }}>
          ...
          <kbd className="hidden md:inline-block text-[10px] px-1.5 py-0.5 rounded" style={{ background: 'var(--border)', color: 'var(--text-muted)' }}>Esc</kbd>
        </div>
